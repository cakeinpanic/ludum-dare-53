export const texts = {
  // Act 1
  '0':
    'You have arrived to your parents house, this is not how you remember it',
  // Ma with letter
  '1':
    "Mother: Hello my dear, we haven't been waiting for you. What letter? I don't know what you are talking about",
  // Sister with letter
  '2':
    'Sister: Hi, you are early. What letter!? Give it to me, go to the yard and find some flowers for the event',
  // Ma with flowers
  '3':
    'Mother: Thanks my dear, your self-sacrifice... Mother went to put flowers in the vase',
  // Talk to sister without letter
  '4':
    "Sister: I'm so excited about the todays event, you will a star of the show.",
  ...
  '22':
    "Sister: You can't leave, you must spend quality time with the family, go talk to dad",

  // Show photo to the ghost
  '24':
    'Ghost: You found memories they hide from you, photo of us before the ritual on the attic. Let me show you the way upstairs',
  // Give cocktail to uncle
  '28':
    'Uncle: Give me the glass, I need it before we start! Oh gosh is strong... I feel dizzy, I need to sit down...',
  // Sit and write a letter
  '29':
    'You sit down and write a letter to J. and ask him to come to the house as soon as possible',
}
